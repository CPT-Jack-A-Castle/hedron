# From https://raw.githubusercontent.com/kolanos/namesilo/master/namesilo.py
# For now, we are hosting this locally as the library isn't updated
# and they may be lazy about pushing to pip again.
